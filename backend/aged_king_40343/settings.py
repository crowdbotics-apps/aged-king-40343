"""
Django settings for aged_king_40343 project.
...
ROOT_URLCONF = 'aged_king_40343.urls'
...
WSGI_APPLICATION = 'aged_king_40343.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "aged_king_40343 API",
    "DESCRIPTION": "API documentation for aged_king_40343 App",
    "VERSION": "v1",
}
